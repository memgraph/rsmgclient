...
fn from_c_mg_value_date2() {
    ...
    let c_mg_value = unsafe { bindings::mg_value_make_date(bindings::mg_date_copy(&c_date)) };
    let mg_value = unsafe { Value::from_mg_value(c_mg_value) };
    assert_eq!(Value::Date(NaiveDate::from_ymd_opt(1971, 1, 1).unwrap()), mg_value);
...
fn from_c_mg_value_date3() {
    ...
    let c_mg_value = unsafe { bindings::mg_value_make_date(bindings::mg_date_copy(&c_date)) };
    let mg_value = unsafe { Value::from_mg_value(c_mg_value) };
    assert_eq!(Value::Date(NaiveDate::from_ymd_opt(1969, 1, 1).unwrap()), mg_value);
...
fn from_c_mg_value_local_date_time1() {
    ...
    let mg_value = unsafe { Value::from_mg_value(c_mg_value) };
    assert_eq!(
        Value::LocalDateTime(NaiveDate::from_ymd_opt(1971, 5, 16).unwrap().and_hms_micro_opt(14, 40, 35, 851241).unwrap()),
        mg_value
    );
...
fn from_c_mg_value_local_date_time2() {
    ...
    let mg_value = unsafe { Value::from_mg_value(c_mg_value) };
    assert_eq!(
        Value::LocalDateTime(NaiveDate::from_ymd_opt(1968, 8, 19).unwrap().and_hms_micro_opt(14, 40, 35, 851241).unwrap()),
        mg_value
    );
...
fn from_c_mg_value_local_date_time3() {
    ...
    let mg_value = unsafe { Value::from_mg_value(c_mg_value) };
    assert_eq!(
        Value::LocalDateTime(NaiveDate::from_ymd_opt(1969, 12, 31).unwrap().and_hms_micro_opt(23, 59, 59, 0).unwrap()),
        mg_value
    );
...
fn from_naive_local_date_time_param_to_mg_value() {
    let query_param =
        QueryParam::LocalDateTime(NaiveDate::from_ymd_opt(1960, 1, 1).unwrap().and_hms_nano_opt(2, 3, 4, 1234).unwrap());
    let c_mg_value = unsafe { *(query_param.to_c_mg_value()) };
    assert_eq!(
        c_mg_value.type_,
